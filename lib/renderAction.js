  ...
  * */
  function getTemplateSource(intentObj) {
    ...
    if(isError) {
      ...
      if(!templateName) {
        templateName = getTemplateFromItem(this.renderTemplates.all); //return the all or none.
      }
      if(templateName) {
    ...
    if(this.renderTemplates.success) {
      let sTemplate = getTemplateFromItem(this.renderTemplates.success);
      if(!sTemplate) {
        sTemplate = getTemplateFromItem(this.renderTemplates.all);
      }
      if(sTemplate) {
    ...
    let aTemplate = getTemplateFromItem(this.renderTemplates.all);
    if(aTemplate) {
